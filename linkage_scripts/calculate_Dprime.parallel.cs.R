...
link_morsels <- foreach(i = seq(ncol(pairs)), .packages = c("tidyverse")) %dopar% {
  print(i)
  mut1 <- pairs[1, i]
  mut2 <- pairs[2, i]
...
print(str_glue("Saved to: results/linkage_out/observed_linkage/observed_Dprime.before_{d}.gt1000.csv"))

...
# Get blosum62 and biochemistry scores
...
change_df <- bind_rows(change_morsels) %>%
  ...
  dplyr::select(ref_AA, var_AA, abs_mw, abs_charge, abs_hydropathy, blosum62_score)
...
ggsave("results/allele_frequency_out/max_freq_versus_global_n.significant.distinct.png", width = 4, height = 4)
...
ggsave("results/allele_frequency_out/median_freq_versus_global_n.significant.distinct.png", width = 4, height = 4)
...
ggsave("results/allele_frequency_out/n_versus_global_n.siginficant.distinct.png", width = 4, height = 4)
...
ggsave("results/allele_frequency_out/blosum62_versus_global_n.significant.distinct.png", width = 4, height = 4)
...
ggsave("results/allele_frequency_out/CoV_versus_global_n.significant.distinct.png", width = 4, height = 4)

...
fwrite(plot_df, "results/allele_frequency_out/freq_stats.minor.csv")
...
ggsave("results/allele_frequency_out/max_freq_versus_global_n.minor.png", width = 4, height = 4)
...
ggsave("results/allele_frequency_out/median_freq_versus_global_n.minor.png", width = 4, height = 4)
...
ggsave("results/allele_frequency_out/n_versus_global_n.minor.png", width = 4, height = 4)
...
ggsave("results/allele_frequency_out/n_filt_versus_global_n.minor.png", width = 4, height = 4)
...
ggsave("results/allele_frequency_out/n_alleles_versus_global_n.minor.png", width = 4, height = 4)
